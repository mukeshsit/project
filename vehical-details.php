    ...
    <div class="container">
        ...
        <div class="sidebar_widget">
            ...
            <form method="post">
                ...
                <div class="form-group">
                    <input type="submit" class="btn"  name="submit" value="Cash On Delivery" onclick="openCashOnDeliveryPage()">
                </div>
                <div class="form-group">
                    <input type="submit" class="btn"  name="submit" value="UPI Payment" onclick="openUpiPaymentPage()">
                </div>
                <?php } else { ?>
